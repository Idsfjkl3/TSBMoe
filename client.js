...
addServerDef("LOCALHOST", localhoster, reg,"80"); 
		    ...
		    if (testServer == null) {
addServerDef("FFA", "profound-bluegill-smart.ngrok-free.app/?ModeActivate=true", reg,"80"); 
		    }
...
OBD.superClass = superClass; //'class' var



//example of custom Z
OBD.prototype.updateZ = function() {
  this.z = 1500 + this.rad;
};



OBD.prototype.getSkinName = function() {
  var skin =
    "obd/" + this.animalSpecies "/bd1_body"
...
OBD.prototype.animalInfo = function () {
     infoO = {};
